...
nuisances['lumi_Uncorrelated'] = {
    ...
    'type': 'lnN',
    'samples': dict((skey, '1.020') for skey in mc if skey not in ['top','WW'])#for skey in mc)
}

nuisances['lumi_Correlated'] = {
    'name': 'lumi_13TeV_correlated',
    'type': 'lnN',
    'samples': dict((skey, '1.009') for skey in mc if skey not in ['top','WW'])#for skey in mc)
}

nuisances['lumi_1718'] = {
    'name': 'lumi_13TeV_1718',
    'type': 'lnN',
    'samples': dict((skey, '1.006') for skey in mc if skey not in ['top','WW'])#for skey in mc)
}
#
...
nuisances['muonpt'] = {
    ...
    'mapUp'      : 'MupTup',
    'mapDown'    : 'MupTdo',
    'samples'    : dict((skey, ['1', '1']) for skey in mc if not skey in ["ggWW", "qqH_sand_off", "qqH_bonly_off", "qqH_sonly_off", "qqH_sand_on", "qqH_sonly_on", "qqH_bonly_on"]),
...
nuisances['muonpt_sig'] = {
    ...
    'mapUp'      : 'MupTup',
    'mapDown'    : 'MupTdo',
    'samples'    : dict((skey, ['1', '1']) for skey in mc if skey in ["ggHToWWOnshell", "ggHToWWOffshell", "ggF_bonly_off", "ggF_sand_off", "ggF_sonly_off", "ggF_sonly_on"]),
...
nuisances['JER'] = {
    ...
    'mapUp'     : 'JERup',
    'mapDown'   : 'JERdo',
    'samples'   : dict((skey, ['1', '1']) for skey in mc if not skey in ["ggWW", "ggHToWWOnshell", "ggHToWWOffshell", "ggF_bonly_off", "ggF_sand_off", "ggF_sonly_off", "ggF_sonly_on"]),
