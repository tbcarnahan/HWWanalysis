...
signalDirectory = '/eos/cms/store/group/phys_higgs/cmshww/fernanpe/HWWNano/Summer20UL18_106x_nAODv9_Full2018v9/MCl1loose2018v9__MCCorr2018v9NoJERInHorn__l2tightOR2018v9'#'/eos/cms/store/group/phys_higgs/cmshww/fernanpe/HWWNano/Summer20UL18_106x_nAODv9_Full2018v9/AddLHE_MEs__AddMC_baseW__AddHWW_Offshell_Wgts__MCl1loose2018v9__MCCorr2018v9NoJERInHorn__l2tightOR2018v9'
...
samples['ggF_sonly_off'] = {
    'name': files,
    'weight': mcCommonWeight + ' * (LHE_mWW > 160)', #changed all LHECandMass to LHE_mWW to calc the correct mWW
    'FilesPerJob': 100, ##
    'suppressNegative' :['all'],
    'suppressNegativeNuisances' :['all'],
}
...
# samples['ggWW'] = {
#     'name': files,
#     'weight': mcCommonWeight+'*1./1.4 * (LHE_mWW <= 160)',
#     'FilesPerJob': 1,
#     'suppressNegative':['all'],
#     'suppressNegativeNuisances' :['all']
# }
