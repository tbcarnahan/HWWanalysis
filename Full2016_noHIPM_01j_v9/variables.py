...
variables['dnnScore_ggH_ON_0j_Opt']  = {   'name': 'dnnScore_ggH_ON_0j',
                                     'range' : ([0.5, 0.68375, 0.8674999999999999, 0.8825000000000001, 1.0],),
...
variables['dnnScore_ggH_ON_1j_Opt']  = {   'name': 'dnnScore_ggH_ON_1j',
                                     'range' : ([0.5, 0.67625, 0.8525, 0.8674999999999999, 1.0],), # 3 sensitive bins, 2 equally spaced bins from 0.5            
                                    'xaxis' : 'dnn_{ggH_on} [GeV]',
                                     'fold' : 3,
