...
##each plot [] matches a samples.py designator (or should lol)
...
groupPlot['WW']  = {
                  ...
                  'isSignal' : 0,
                  'color': 851, # kAzure -9 
                  'samples'  : ['WW', 'ggWW', 'ggF_bonly_off']#['WW', 'ggWW', 'WWewk', 'ggF_bonly_off'] ##
              }
...
# plot['WWewk']  = { ##these all correspond to samples.py
#                   'color': 851, # kAzure -9 
#                   'isSignal' : 0,
#                   'isData'   : 0,
#                   'scale'    : 1.0   # ele/mu trigger efficiency   datadriven
