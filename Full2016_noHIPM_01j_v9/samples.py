...
##TC -- mcCommonWeight_custom = 'XSWeight', where mcCommonWeight = 'XSWeight*METFilter_MC*PromptGenLepMatch2l*SFweight'
# samples['ggF_sonly_off'] = {
#     'name': files,
#     'weight':mcCommonWeight_custom + ' * p_Gen_GG_SIG_kappaTopBot_1_ghz1_1_MCFM * p_Gen_CPStoBWPropRewgt * HWWOffshell_combineWgt * (LHECandMass <= 160)', #mcCommonWeight + ' * (LHECandMass > 160)',
#     'FilesPerJob': 4,
#     'suppressNegative' :['all'],
#     'suppressNegativeNuisances' :['all'],
# }
...
#     'name': files,
#     'weight': mcCommonWeight_custom + ' * p_Gen_GG_SIG_kappaTopBot_1_ghz1_1_MCFM * p_Gen_CPStoBWPropRewgt * HWWOffshell_combineWgt * (LHECandMass <= 160)',#mcCommonWeight+'*1./1.4 * (LHECandMass > 160)',
#     'FilesPerJob': 1,
#     'suppressNegative':['all'],
#     'suppressNegativeNuisances' :['all']
# }
